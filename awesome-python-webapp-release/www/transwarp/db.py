...
def update(sql, *args):
    ...
    >>> u1 = dict(id=1000, name='Jordan', email='jordan@test.org', passwd='123456', last_modified=time.time())
    >>> insert('user', **u1)
    1
    ...
    >>> u2.passwd
    u'123456'
    >>> update('update user set email=?, passwd=? where id=?', 'jordan@example.org', '654321', 1000)
    1
    >>> u3 = select_one('select * from user where id=?', 1000)
    >>> u3.email
    u'jordan@example.org'
    >>> u3.passwd
    u'654321'
